...
This tool **supports MySQL 5.7, 8.x, 9.x, [Percona Server](https://www.percona.com/software/mysql-database/percona-server) 8.x and MariaDB 10.x, 11.x and 12.x** and runs under **Python 3.9+**.
