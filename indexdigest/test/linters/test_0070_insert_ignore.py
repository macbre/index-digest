...
class TestInsertIgnore(TestCase, DatabaseTestMixin):
    ...
    def test_queries(self):
        ...
        self.assertEqual(str(reports[1].context['query']), "INSERT  IGNORE INTO `0070_insert_ignore` VALUES ('123', 9, '2017-01-01');")
        self.assertEqual(str(reports[2].context['query']), "INSERT /* foo */ IGNORE INTO `0070_insert_ignore` VALUES ('2017-01-01', 9, 123);")
        # assert False
